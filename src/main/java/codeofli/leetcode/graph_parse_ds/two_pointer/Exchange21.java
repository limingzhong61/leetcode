...
public class Exchange21 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(exchange21.exchange(TransformString.toIntArray("[1,2,3,4]"))));
        System.out.println(Arrays.toString(exchange21.exchange(TransformString.toIntArray("[1,3,2,4]"))));
    }
}
