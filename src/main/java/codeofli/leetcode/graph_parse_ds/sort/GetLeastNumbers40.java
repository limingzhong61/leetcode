...
public class GetLeastNumbers40 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[3,2,1]"), 2)));
        System.out.println(Arrays.equals(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[3,2,1]"), 2), TransformString.toIntArray("[2,1]")));

        System.out.println(Arrays.toString(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[0,1,2,1]"), 1)));
        System.out.println(Arrays.equals(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[0,1,2,1]"), 1), TransformString.toIntArray("[0]")));

        System.out.println(Arrays.toString(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[0,0,2,3,2,1,1,2,0,4]"), 10)));

        System.out.println(Arrays.toString(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[0,0,0,2,0,5]"), 0)));
        System.out.println(Arrays.equals(getLeastNumbers40.getLeastNumbers(
                TransformString.toIntArray("[0,0,0,2,0,5]"), 0), TransformString.toIntArray("[]")));
