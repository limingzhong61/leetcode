...
public class FindContinuousSequence57II {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(StringTransformUtil.matrixToStr(findContinuousSequence.findContinuousSequence(9)));
        System.out.println(StringTransformUtil.matrixToStr(findContinuousSequence.findContinuousSequence(9))
                .equals("[[2,3,4],[4,5]]"));

        System.out.println(StringTransformUtil.matrixToStr(findContinuousSequence.findContinuousSequence(15)));
        System.out.println(StringTransformUtil.matrixToStr(findContinuousSequence.findContinuousSequence(15))
                .equals("[[1,2,3,4,5],[4,5,6],[7,8]]"));

        System.out.println(StringTransformUtil.matrixToStr(findContinuousSequence.findContinuousSequence(10)));
        System.out.println(StringTransformUtil.matrixToStr(findContinuousSequence.findContinuousSequence(10))
                .equals("[[1,2,3,4]]"));
    }
