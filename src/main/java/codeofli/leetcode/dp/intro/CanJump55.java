...
public class CanJump55 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(canJump55.canJump(StringTransformUtil.toIntArray("[2,3,1,1,4]")));
        System.out.println(canJump55.canJump(StringTransformUtil.toIntArray("[3,2,1,0,4]")));
        System.out.println(canJump55.canJump(StringTransformUtil.toIntArray("[2,0,6,9,8,4,5,0,8,9,1,2,9,6,8,8,0,6,3,1,2,2,1,2,6,5,3,1,2,2,6,4,2,4,3,0,0,0,3,8,2,4,0,1,2,0,1,4,6,5,8,0,7,9,3,4,6,6,5,8,9,3,4,3,7,0,4,9,0,9,8,4,3,0," +
