package codeofli.leetcode.bruce_solution.bruce_search.permutation;
...
public class Permute46 {
    ...
    public static void main(String[] args) {
        codeofli.my.solution_template.bruce_search.permutation.Permute permute = new codeofli.my.solution_template.bruce_search.permutation.Permute();
