package lmz.util.solution_template.sort.linked_list;

import lmz.algorithm.data_structure.linked_list.util.ListNode;
import lmz.util.solution_template.data_structure.linked_list.LinkedListUtil;

import static lmz.util.solution_template.data_structure.linked_list.LinkedListUtil.mergeTwoLists;
